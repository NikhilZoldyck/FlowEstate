...
│   ├── mint/page.tsx          # Property minting interface
│   ├── marketplace/page.tsx   # NFT marketplace and trading
│   └── api/properties/        # RESTful API for property data
├── components/
│   ├── navigation.tsx         # Global navigation with wallet status
│   ├── web3-provider.tsx      # Web3 context and state management
│   ├── mint-nft-form.tsx
│   └── ui/                    # Reusable UI components
├── lib/
│   ├── web3.ts               # Blockchain utilities and contract ABIs
│   └── supabase/             # Database client configuration
└── hooks/
    └── use-web3.ts           # Custom React hook for Web3 state
\\\`
